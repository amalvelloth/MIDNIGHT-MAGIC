    ...
    <div className="container-about">
      <section className="about-section1">
        <div className="hero-about">
          ...
          <p>Whether it's an anniversary, product launch, or any other special occasion, we thrive on turning your vision into reality. Our attention to detail ensures that every moment is crafted with precision and creativity.
</p>
        </div>
      </section>
    </div>
